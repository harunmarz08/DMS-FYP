...
class DocumentController extends Controller
{
    ...
    public function index(Project $project, $type = 'main')
    {
        ...
        $view = $type === 'cover' ? 'project.template.KK3cover' : 'project.template.KK3';
     ...
     */
    public function printContentToTemplate(Request $request, Project $project, TemplateDocument $templateDocument)
    {
        $kertas_kerja = new \PhpOffice\PhpWord\TemplateProcessor('KK3-template.docx');

        $templateContent = TemplateDocument::where('id', $templateDocument->id)->firstOrFail();
        ...
        $fileName = $project->name .'testing-full'. $project->version .'-output.docx';

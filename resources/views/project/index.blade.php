                ...
                {{-- @if ($project->user_id == auth()->user()->id) --}}
                    <x-directory color="white" class="grid grid-cols-3 gap-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>Created by: <p class="m-2 px-2 bg-gray-300 text-gray-800 rounded-xl inline-block">
                                    {{ $project->created_by }}</p>
                            </div>
                            <div>Status:
                                <p
                                ...
                                <div class="p-3" name="mark-project-{{ $project->id }}">
                                    <a href="{{ route('project.mark-as-complete', ['project' => $project]) }}"
                                        ...
                                        @if ($project->status == 'On-going')
                                            <svg name="checkmark" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        @elseif($project->status == 'Completed')
                                            <svg name="cross" width="22" height="22" viewBox="0 0 64 64"
                                                xmlns="http://www.w3.org/2000/svg"

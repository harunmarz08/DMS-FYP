            ...
            @foreach ($projects as $project)
                <x-directory color="white" class="grid grid-cols-3 gap-4">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div>Date Created: <p class="m-2 px-2 bg-gray-300 text-gray-800 rounded-xl inline-block">{{ $project->created_at->format('H:i d, M Y') }}</p></div>
                        <div>Status: <p class="m-2 px-2 {{ $project->status == 'New' ? 'bg-gray-300 text-gray-800' : ($project->status == 'On-going' ? 'bg-yellow-300 text-gray-800' : '') }} rounded-xl inline-block">{{ $project->status }}</p></div>
                    </div>

                        ...
                        <div class="p-4 m-4">
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="text-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it4"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="text-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it5_1"/>
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it5_2"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="text-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it6_1"/>
                                    <h1 class="text-l font-semibold mb-4">6.2. Nyatakan lokasi baharu yang dicadangkan &#40;jika berkaitan&#41;</h1>
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it6_2"/>
                                    <h1 class="text-l font-semibold mb-4">6.3. Nyatakan kelulusan Audit Lokasi &#40;sekiranya berkaitan&#41;</h1>
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it6_3"/>
                                </div>
                            </x-directory>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="border border-gray-300">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it7_bmk"/>
                                                    </td>
                                                    <td class="border border-gray-300">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it7_bmp"/>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="table-fixed border-collapse border border-gray-200 w-2/3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="border border-gray-300">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it7_enk"/>
                                                    </td>
                                                    <td class="border border-gray-300">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it7_enp"/>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="table-fixed border-collapse border border-gray-200 w-1/3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="border border-gray-300">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it7_bma"/>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="table-fixed border-collapse border border-gray-200 w-1/3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="border border-gray-300">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it7_ena"/>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="table-fixed w-full border-collapse border border-gray-200 ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it8_cb1"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it8_cb2"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it8_cb3"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it8_cb4"/>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="text-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it9"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it10"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="text-left col-span-4 ml-2">
                                    <h1 class="text-l font-semibold mb-4">Nyatakan standard program MQA yang
                                        digunapakai.</h1>
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it11"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="text-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it12"/>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it13"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    <h1 class="text-l font-semibold mb-4">Nyatakan mod penawaran sama ada kerja kursus,
                                        ...
                                        tidak </h1>
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it14"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it15"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <table class="table-fixed  border-collapse border border-gray-200 w-3/4">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="border border-gray-300 ">
                                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it16_1"/>
                                                </td>
                                                <td class="border border-gray-300 ">
                                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it16_2"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="border border-gray-300 ">
                                                ...
                                                <td class="border border-gray-300 ">
                                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it16_3"/>
                                                </td>
                                                <td class="border border-gray-300 ">
                                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it16_4"/>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it16_5"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <table class="table-fixed  border-collapse border border-gray-200 w-3/4">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="border border-gray-300 ">
                                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it17_1cb1"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="border border-gray-300 px-4 py-2">Separuh Masa</td>
                                                <td class="border border-gray-300 ">
                                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it17_1cb2"/>
                                                </td>
                                            </tr>                                            
                                        </tbody>
                                    </table><br>
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it17_2"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6 gap-4 p-4">
                                ...
                                <div class="text-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it18_1"/>
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it18_2"/>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it19" />
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it20"/>                                    
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it21_1"/>
                                    <h1 class="text-l font-semibold mb-4">21.2. Nyatakan lokasi baharu yang dicadangkan &#40;jika berkaitan&#41;</h1>
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it21_2"/>
                                    <h1 class="text-l font-semibold mb-4">21.3. Nyatakan kelulusan Audit Lokasi &#40;sekiranya berkaitan&#41;</h1>
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it21_3"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6 gap-4">
                                ...
                                <div class="justify-self-start col-span-4">
                                        ...
                                        <table class="table-fixed w-full border-collapse border border-gray-200">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_1_en"/>
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_1_bm"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_1x"/>
                                                    </td>
                                                </tr>
                                                <div name="stack-row1">
                                                    <tr>
                                                        ...
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_2a"/>
                                                        </td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_2ax"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border border-gray-300 px-4 py-2">Kod Program &#40;dalaman&#41;</td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_2b"/>
                                                        </td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_2bx"/>
                                                        </td>
                                                    </tr>
                                                </div>
                                                <div name="stack-row2">
                                                    <tr>
                                                        ...
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_3a"/>
                                                        </td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_3ax"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border border-gray-300 px-4 py-2">Entiti Akademik</td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_3b"/>
                                                        </td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_3bx"/>
                                                        </td>
                                                    </tr>
                                                </div>
                                                <div name="stack-row3">
                                                    <tr>
                                                        ...
                                                        <td class="border border-gray-300 ">
                                                            ...
                                                            <x-expanding-textarea id="it22_4peo1" name="it22_4peo1" placeholder="Type here..." class="w-full" name="it22_4peo1"/>
                                                            <x-input-label for="it22_4peo2">2. PEO digugurkan TANPA diganti</x-input-label>
                                                            <x-expanding-textarea id="it22_4peo2" name="it22_4peo2" placeholder="Type here..." class="w-full" name="it22_4peo2"/>
                                                            <x-input-label for="it22_4peo2">3. PEO ditambah</x-input-label>
                                                            <x-expanding-textarea id="it22_4peo3" name="it22_4peo3" placeholder="Type here..." class="w-full" name="it22_4peo3"/>
                                                        </td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_4peox"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border border-gray-300 ">
                                                            <x-input-label for="it22_4peo2">1. PLO digugurkan DAN diganti</x-input-label>
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_4plo1"/>
                                                            <x-input-label for="it22_4peo2">2. PLO digugurkan TANPA diganti</x-input-label>
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_4plo2"/>
                                                            <x-input-label for="it22_4peo2">3. PLO ditambah</x-input-label>
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_4plo3"/>
                                                        </td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_4plox"/>
                                                        </td>
                                                    </tr>
                                                </div>
                                                <div name="stack-row4">
                                                    <tr>
                                                        ...
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_5a"/>
                                                        </td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_5ax"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border border-gray-300 px-4 py-2 text-left">b. Kaedah Pengajian</td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_5b"/>
                                                        </td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_5bx"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border border-gray-300 px-4 py-2 text-left">c. Kaedah Penyampaian</td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_5c"/>
                                                        </td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_5cx"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border border-gray-300 px-4 py-2 text-left">d. Mod Penawaran</td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_5d"/>
                                                        </td>
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_5dx"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="border border-gray-300 ">
                                                            <div class="flex flex-row">
                                                                <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_5e"/>
                                                        ...
                                                        <td class="border border-gray-300 ">
                                                            <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_5ex"/>
                                                        </td>
                                                    </tr>
                                                </div>
                                                <tr>
                                    ...
                                    <h1 class="text-l font-semibold mb-4">22.2. Kaedah Peratus Perubahan Semakan
                                        Kurikulum
                                        Program </h1>
                                    <div class="overflow-x-auto">
                                        <table class="table-fixed border-collapse border border-gray-200">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_71a"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_71b"/>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_72a"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_72b"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_72c"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_72p"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_73a"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_73b"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_73c"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_73p"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it22_8"/>
                                </div>
                            </x-directory>
                                            ...
                                            <thead>
                                                <tr class="bg-gray-100">
                                                    ...
                                                    <th class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_1a"/>
                                                    </th>
                                                    <th class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_1b"/>
                                                    </th>
                                                    <th class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_1c"/>
                                                    </th>
                                                    <th class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_1d"/>
                                                    </th>
                                                    <th class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_1e"/>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_2a"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_2b"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_2c"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_2d"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_2e"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border border-gray-300 px-4 py-2"> Enrolmen </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_3a"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_3b"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_3c"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_3d"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_3e"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border border-gray-300 px-4 py-2"> Keluaran </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_4a"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_4b"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_4c"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_4d"/>
                                                    </td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it23_4e"/>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table><br>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it24_1"/>
                                    <h1 class="text-l font-semibold mb-4">24.2. Nyatakan keperluan kelayakan asas termasuk Band MUET</h1>
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it24_2"/>
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it24_3"/>
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it24_4"/>
                                    <h1 class="text-l font-semibold mb-4">24.5. Nyatakan kategori OKU yang diterima masuk ke program ini.</h1>
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it24_5"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it25_1"/>
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it25_2"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it26_1"/>
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it26_2"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it27_1"/>
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it27_2"/>
                                    <h1 class="text-l font-semibold mb-4">27.3. Nyatakan implikasi kewangan yang berkaitan.</h1>
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it27_3"/>
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it27_4"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it28"/>
                                </div>
                            </x-directory>
                                        ...
                                        <table class="table-fixed w-full border-collapse border border-gray-200 ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it29_1"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border border-gray-300 px-4 py-2">Kelulusan asal program oleh JKPT</td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it29_2"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border border-gray-300 px-4 py-2">Sesi program asal ditawarkan</td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it29_3"/>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table-fixed w-full border-collapse border border-gray-200 ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it30_1"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border border-gray-300 px-4 py-2">Akreditasi Penuh/MQA</td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it30_2"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border border-gray-300 px-4 py-2">Sesi program asal ditawarkan</td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it30_3"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border border-gray-300 px-4 py-2">Mesyuarat Jawatankuasa Akademik Fakulti &#40;JKAF&#41;</td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it30_4"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border border-gray-300 px-4 py-2">Mesyuarat Jawatankuasa Kurikulum Universiti &#40;JKKU&#41;</td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it30_5"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border border-gray-300 px-4 py-2">Mesyuarat Jawatankuasa Tetap Senat Kurikulum dan Kualiti Akademik &#40;JKTS KKA&#41;</td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it30_6"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border border-gray-300 px-4 py-2">Mesyuarat Senat</td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it30_7"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border border-gray-300 px-4 py-2">Mesyuarat Lembaga Pengarah Universiti</td>
                                                    <td class="border border-gray-300 ">
                                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it30_8"/>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <x-expanding-textarea placeholder="Nama kertas kerja" class="w-full" name="it31"/>
                                </div>
                            </x-directory>
                        </div>
                    </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-2">
                        <div class="p-4 m-4">
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it_excel1"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    <x-expanding-textarea placeholder="Type here..." class="w-full" name="it_excel2"/>
                                </div>
                            </x-directory>
                            ...
                            <x-directory color="white" class="grid grid-cols-6">
                                ...
                                <div class="justify-self-left col-span-4 ml-2">
                                    ...
                                    <div class="justify-self-left col-span-4 ml-2">
                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it_excelx"/>
                                    </div>
                                    <h1 class="text-l font-semibold mb-4">Justifikasi:</h1>
                                    <div class="justify-self-left col-span-4 ml-2">
                                        <x-expanding-textarea placeholder="Type here..." class="w-full" name="it_excelj"/>
                                    </div>
                                </div>
                            </x-directory>
                        </div>
                        ...
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="flex justify-end py-4">
                                <x-secondary-button id="save-draft" color="black"
                                    onclick="submitForm('{{ route('project.template.save-draft',['project' => $project]) }}')"
